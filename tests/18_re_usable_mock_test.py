...
@fixture
def re_usable_mocker(mocker):
    """
    Fixtures can invoke mocker for more "re-usable" mocks
    """
...
def test_mocker_with_exception(re_usable_mocker):
    re_usable_mocker.side_effect = Exception("Oh noes!")
